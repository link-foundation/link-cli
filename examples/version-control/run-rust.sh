#!/usr/bin/env bash
# Demonstrates the optional version-control layer with the Rust `clink` binary.
#
# Usage:
#   ./examples/version-control/run-rust.sh
...
clink --db data.links --vc "() ((1 1) (2 2))"
ls -1 *.links
...
clink --db data.links --vc --branch feature --branch-from 2 "() ((3 3))"
